# OpenAI Adapter & Route Testing Framework

## 📋 Обзор проекта

**OpenAI Adapter & Route Testing Framework** — это комплексное решение для эмуляции, тестирования и маршрутизации OpenAI-совместимых API. Проект предназначен для разработчиков AI-сервисов, которым требуется:

- Эмулировать поведение OpenAI API для тестирования
- Обрабатывать вызовы функций (function/tool calling)
- Тестировать маршруты и интеграции с различными AI-моделями
